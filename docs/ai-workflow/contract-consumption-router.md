...
This runtime consumes Law Firm OS Semantic Substrate contracts. It does not own schema meaning, lifecycle states, mutation authority, or promotion authority.
...
```text
your-org/LawFirm-os-semantic-substrate   # example; see .github/workflows/ci.yml for CI default
```
...
- validating payloads against Law Firm OS Semantic Substrate schemas
- checking route registry behavior
- planning a future contract change that belongs in the Law Firm OS Semantic Substrate repository
...
Runtime task
  -> Does it change schema meaning?
      -> yes: stop; route to Law Firm OS Semantic Substrate contract repo
      -> no
...
- whether follow-up in the Law Firm OS Semantic Substrate contract repo is required
