...
All AI-assisted work in this runtime repo must preserve the contract-consumer boundary with `lowelltwong-alt/fmg-fractal-capability-ontology`.

## Cycle

1. **Orient** — read `README.md`, runtime boundary docs, local dev docs, and `AI_WORK_START_HERE.md`.
2. **Confirm contract authority** — identify the FMG contract repo path and pinned contract SHA when relevant.
...
No live connector, production audit capture, raw transcript capture, or real FMG data handling is authorized by this router.
