...
EXPECTED_OWNER_REPO = "LawFirm-os-exceptions-lake-runtime"
...
REQUIRED_WATCHED = {
    ...
    "docs/",
    "registry/",
    "registry/intake-lake-admission-review-registry.json",
...
def validate_governance_dependency_map_mirror(path: Path = MIRROR) -> dict[str, Any]:
    ...
    false_keys = (
        ...
        "local_repo_may_mutate_canon",
        "local_repo_may_store_raw_legal_payloads",
        "local_repo_may_promote_runtime_evidence_to_authority",
